  const slides = [
    ...
    { title:"Conhecendo o Projeto", objetivo:"Detalhar o que o sistema efetivamente faz.", itens:["Mostrar o projeto funcionando"], dica:"Priorize qualidade: 4 funcionalidades bem explicadas valem mais que 10 citadas de raspão." },

    { title:" Desafios e Planos futuros", objetivo:"Mostrar visão de continuidade para o projeto.", itens:["Principais obstáculos técnicos ou de equipe enfrentados","Como esses obstáculos foram contornados","O que a equipe faria diferente numa próxima versão", "Próximas funcionalidades planejadas","Possibilidade de escala ou uso real do projeto","Principais aprendizados que a equipe leva"], dica:"Termine esse bloco com ambição, não com desculpas." },
